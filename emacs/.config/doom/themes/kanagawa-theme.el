...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-level-1 ((,class (:bold t :foreground ,"#e46876" :height 1.6))))
   `(org-level-2 ((,class (:bold nil :foreground , "#ffa066" :height 1.4))))
   `(org-level-3 ((,class (:bold t :foreground ,"#e6c384" :height 1.2))))
   ...
   `(org-table ((,class (:foreground ,lotusGray :background ,bg2))))
   ...
   ;; Background highlight for LLM responses
   ;; `(gptel-response-highlight ((,class (:background ,waveBlue2))))
   ;; Color for the fringe bar or margin indicator
   `(gptel-response-fringe-highlight ((,class (:foreground ,autumnGreen :weight bold))))
