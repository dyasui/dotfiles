...
- [[#core-behavior][Core Behavior]]
  ...
  - [[#custom-elisp-functions][Custom elisp functions]]
...
- [[#editor-enhancements][Editor Enhancements]]
  ...
  - [[#org-syntax-wrap-functions][Org syntax wrap functions]]
...
- [[#note-takingpersonal-knowledge-management][Note taking/Personal Knowledge Management]]
  - [[#org-roam][Org-Roam]]
  - [[#vulpea][Vulpea]]
...
** Vulpea
This package seems like an alternative PKM system type of thing to org-roam, but looks a little more intuitive to me on a first read through of their documentation. I'll try it out and see if this gets me to switch over my org notes from Logseq.
#+begin_src emacs-lisp
(use-package vulpea
  :ensure t
  :init
...
Copied from this [[https://github.com/karthink/gptel/discussions/1067][github discussion]] to list openrouter pricing in gptel model selection.
#+begin_src emacs-lisp
