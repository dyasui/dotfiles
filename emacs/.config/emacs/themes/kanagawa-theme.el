...
;;; Commentary:
;;; kanagawa theme created by  in 2025
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(term-color-black ((,class (:foreground ,fg2 :background ,bg2))))
   ...
   `(minibuffer-prompt ((,class (:bold t :foreground , "#9fb5c9"))))
   `(default-italic ((,class (:italic t))))
	 `(link ((,class (:foreground ,const :underline t))))
	 `(org-code ((,class (:foreground ,fg2))))
	 `(org-hide ((,class (:foreground , bg1))))
   `(org-level-1 ((,class (:bold t :foreground ,"#e46876" :height 1.2))))
   `(org-level-2 ((,class (:bold nil :foreground , "#ffa066" :height 1.1))))
   `(org-level-3 ((,class (:bold t :foreground ,"#e6c384"))))
   `(org-level-4 ((,class (:bold nil :foreground ,"#87a987"))))
   ...
   `(org-document-info-keyword ((,class (:foreground , "#c5c9c5"))))
   ...
   `(term ((,class (:foreground ,fg2 :background ,bg2))))
   ...
   (if (< emacs-major-version 22)
     ...
     (custom-theme-set-faces
      'kanagawa
      `(show-paren-match ((,class (:foreground , "#c84053" :background , bg1 ))))
      `(show-paren-mismatch ((,class (:foreground ,bg1 :background ,warning))))))
   ;; emacs >= 26.1
   (when (>= emacs-major-version 26)
     (custom-theme-set-faces
      'kanagawa
      `(line-number ((t (:foreground ,"#54546d" :background , "#363646" ))))
      `(line-number-current-line ((t (:foreground ,"#FF9E3B" :background ,"#363646" :weight bold))))))
...
(when (>= emacs-major-version 27)
  (custom-theme-set-faces
   'kanagawa
   `(tab-line              ((,class (:background ,"#393836" :foreground ,fg4))))
   `(tab-line-tab          ((,class (:background ,"#b7d0ae"))))
   `(tab-line-tab-inactive ((,class (:background ,bg4 :foreground ,fg4))))
   `(tab-line-tab-current  ((,class (:background ,bg2 :foreground ,fg1))))
   `(tab-line-highlight    ((,class (:background ,bg3 :foreground ,fg2))))))
 (when (>= emacs-major-version 28)
    (custom-theme-set-faces
     'kanagawa
